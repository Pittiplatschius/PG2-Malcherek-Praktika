...
#include <memory>
#include "../Praktikum_3/mainwindow.h"
...
Q_CONSTINIT static const qt_meta_stringdata_TravelAgencyUI_t qt_meta_stringdata_TravelAgencyUI = {
    {
        ...
        QT_MOC_LITERAL(61, 21),  // "pushButton_Auswaehlen"
        QT_MOC_LITERAL(83, 22),  // "pushBotton_Exportieren"
        QT_MOC_LITERAL(106, 26),  // "pushButton_Liste_sortieren"
        QT_MOC_LITERAL(133, 23),  // "doubleClickedListWidget"
        QT_MOC_LITERAL(157, 11),  // "listDetails"
        QT_MOC_LITERAL(169, 2)   // "id"
    },
    "TravelAgencyUI",
    "pushButton_Einlesen",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_TravelAgencyUI[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       7,    0,   61,    2, 0x108,    6 /* Private | MethodIsConst  */,
       8,    1,   62,    2, 0x108,    7 /* Private | MethodIsConst  */,
...
void TravelAgencyUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->doubleClickedListWidget(); break;
        case 6: _t->listDetails((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
